...
def _testnet_panel_inner(reports_dir: str = "reports") -> str:
    ...
    ev_class = {"open": "badge-good", "would_trade": "badge-neutral", "hold": "badge-warn",
                ...
                "trail": "badge-info", "closed": "badge-info"}
    acts = "".join(
  ...
  <div class="tn-head">
    <div><div class="hero-kicker">TESTNET TRADING BOT · FAKE MONEY</div>
      <div class="muted" style="font-size:12px;margin-top:4px">
        ...
        {int(s.get('leverage',0))}x · SL {float(s.get('sl_pct',0))}% ·
        trail {float(s.get('trail_pct',0))}% {'from +%.0f%% ROI' % float(s['trail_activation_roi']) if s.get('trail_activation_roi') else ''} ·
